  ...
  ?>
      <div class="row border border-info-subtle  rounded  m-4 p-3" style="width: 18rem;">
        <div class="list-group list-group-flush  ">
          <p class="col-1 ">
          <h4>Nomber :</h4><?php echo $row["id"]; ?></p>
          <p class="col-3 ">
          <h4>Email :</h4><?php echo $row["email"]; ?></p>
          <p class="col-5 ">
          <h4>Message :</h4><?php echo $row["messages"]; ?></p>
        </div>
      </div>
...
<!--list-group All messages -->

<?php
require '../crud/select_data_mess_all.php';
if ($result->num_rows > 0) {
  // output data of each row
  while ($row = $result->fetch_assoc()) {
?>
    ...
    <ul class="list-group">
      <li class="list-group-item">
        <p class=" "><b>Nomber :</b><?php echo $row["id"]; ?> <span>Email :</span><?php echo $row["email"]; ?> <span>Message :</span><?php echo $row["messages"]; ?></p>
      </li>
    </ul>
